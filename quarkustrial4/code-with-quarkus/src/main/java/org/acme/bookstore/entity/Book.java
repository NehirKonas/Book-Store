...
public class Book {
    ...
    public Book(String title, BookFormat format, BookLang language, LocalDate date, double price, int pageNumber, String isbn, int stock, Genre genre, Long publisher, long authorId) {
        this.title = title;
        this.format = format;
